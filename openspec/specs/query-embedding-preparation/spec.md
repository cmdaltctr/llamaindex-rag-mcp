...
Define how raw query text is prepared before embedding: an optional query-only
instruction applied at the preparation seam, model-agnostic handling inside
retrieval, and evidence-gated promotion of any packaged instruction default.
