...
- **GIVEN** `RETRIEVAL__RERANK_ENABLED=false`
- **AND** `RETRIEVAL__RERANK_ENABLED_FOR_SEMANTIC=false`
...
- **GIVEN** `RETRIEVAL__RERANK_ENABLED=true`
...
- **GIVEN** `RETRIEVAL__RERANK_ENABLED=false`
- **AND** `RETRIEVAL__RERANK_ENABLED_FOR_SEMANTIC=true`
- **AND** `RETRIEVAL__HARD_TECHNICAL_THRESHOLD=0.3`
