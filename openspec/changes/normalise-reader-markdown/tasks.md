...
- [x] 5.4 Commit with a `feat(ingestion):` message whose body names the one-off reprocessing (identity schema 6). Follow the schema 5 precedent (`2342424`, no `BREAKING CHANGE` footer) unless the operator decides otherwise. Ask the operator before pushing or opening the PR. Verify: the operator confirms. 2026-09-25: committed as `9d06666`; the operator approved the push; PR #97 to `v3`.
