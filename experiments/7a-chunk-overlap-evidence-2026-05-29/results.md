...
The current production default, `CHUNK_OVERLAP=100`, remains safe on a harder
evidence-level corpus (Qasper-dev).
...
_pp = percentage points (e.g., -3.78 pp means overlap 100 is 3.78 percentage points worse than overlap 64); MRR delta = change in Mean Reciprocal Rank (negative means worse); Chunk ratio = ratio of chunk counts (overlap 100 / overlap 64)._
