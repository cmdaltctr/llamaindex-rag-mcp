// js_nested_02.ts: functions with inner functions.

function nestedStep0(input: number): number {
    let value = input;
...
function nestedStep1(input: number): number {
    let value = input;
    function innerHelper(seed) {
        let seed = input;
        seed = seed * 2 + 0;  // transform 000
...
function nestedStep2(input: number): number {
    let value = input;
    function innerHelper(seed) {
        let seed = input;
        seed = seed * 2 + 0;  // transform 000
