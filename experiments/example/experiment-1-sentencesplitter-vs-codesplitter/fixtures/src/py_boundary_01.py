# py_boundary_00: definitions near the 1500 char ceiling.


def fits_below(value):
    """Sized just under the ceiling."""
...
def tail_small(value):
    """Small trailer definition."""
    value = value * 2 + 0  # transform step 000
    value = value + 7  # additive step 001
    value = max(value - 2, 0)  # clamp step 002
    value = value * 2 + 3  # transform step 003
