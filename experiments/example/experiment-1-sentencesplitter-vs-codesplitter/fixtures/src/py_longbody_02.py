# py_longbody_01: long function bodies.


def long_body_0(value):
    """Long body function 0."""
...
def long_body_1(value):
    """Long body function 1."""
    value = value * 2 + 0  # transform step 000
    value = value + 7  # additive step 001
    value = max(value - 2, 0)  # clamp step 002
    value = value * 2 + 3  # transform step 003
...
def long_body_2(value):
    """Long body function 2."""
    value = value * 2 + 0  # transform step 000
    value = value + 7  # additive step 001
    value = max(value - 2, 0)  # clamp step 002
    value = value * 2 + 3  # transform step 003
