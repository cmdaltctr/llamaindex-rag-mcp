"""Prepare Experiment 6b's evidence-dense corpus and QA labels.

Primary path: normalise a local HiCBench checkout/download into this repo's
experiment format. Fallback path: generate a small synthetic evidence-dense
Markdown corpus only when explicitly requested.
"""
