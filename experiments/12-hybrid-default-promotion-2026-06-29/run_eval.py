"""Run Experiment 12: Hybrid Default Promotion.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Experiment 12")
    ...
    payload = {
        "experiment": "12-hybrid-default-promotion-2026-06-29",
