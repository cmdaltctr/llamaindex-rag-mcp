...
| 29       | [PDF routing repeat study](./29-pdf-routing-repeat-2026-09-13/)                                      | 2026-09-13 | PLANNED (approvals pending) | `repeat-pdf-routing-study`. Preregistered repeat of experiment 28's routing question on an operator-approved collection: independent page labels, development/held-out split, pinned historical baseline (`afe151e`) replayed against the post-`9bf4810` candidate through the production gate. Repairs over exp 28: identity-bound checkpoint refuses unsafe resume, public outputs carry no paths or exception text |
