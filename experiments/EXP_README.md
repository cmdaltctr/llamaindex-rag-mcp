...
| 11 | [LiteParse PDF quality and speed](./11-liteparse-pdf-quality-2026-06-20/) | 2026-06-20 | PLANNED | Validation gate for OpenSpec change `use-liteparse-as-pdf-reader`. Tests whether LiteParse v2 (Rust/PDFium) improves nDCG@10 ≥5% and ingest wall-clock ≥20% vs the current pypdf baseline on a real academic-PDF corpus. ADR-020 (pending) records the decision. |
