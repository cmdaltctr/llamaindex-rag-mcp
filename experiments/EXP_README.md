...
| 20       | [Citation faithfulness](./20-citation-faithfulness-2026-09-02/)                                    | 2026-09-02 | READY TO RUN          | `add-grounded-answer-synthesis-3` task 7.2 / security F4 follow-up. Does an LLM judge detect unsupported claims (recall ≥ 0.80, false rejection ≤ 0.10, P95 ≤ 5 s) where a lexical baseline cannot (gap ≥ 0.20)? Decides whether `ok` gains claim-support verification, verification ships as opt-in diagnostics, or the referential-only guarantee stays. Ground truth frozen (120 triples: 40 faithful, 20 paraphrase, 20 contradicted, 20 invented, 20 swapped) and runner written; cell 20A computed (best threshold 0.9: recall 0.95, false rejection 0.267, paraphrase recall 0.2 — the predicted overlap). Operator review of ground truth gates the judge runs |
