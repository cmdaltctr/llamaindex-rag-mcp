...
| 24       | [OCR routing evaluation](./24-ocr-routing-eval-2026-09-08/)                                        | 2026-09-08 | PLANNED (gates frozen)  | `improve-rag-input-quality-5` task 5.1. Fast-path baseline vs routed PaddleOCR-VL worker on the 5 held-out evaluation fixtures. Gates: 0 structured missing-content failures; fast-path byte-identity; worker ≤ 180 s/page p95; routing decision p95 ≤ 50 ms (measured 2.26 ms, `output/routing_overhead.json`) |
