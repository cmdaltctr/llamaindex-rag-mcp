...
| 25       | [Token-aware chunking ablation](./25-token-chunking-ablation-2026-09-08/)                          | 2026-09-08 | PLANNED (gates frozen)  | `improve-rag-input-quality-5` task 5.2. Baseline splitter vs model-token Markdown chunker on the exp 22 corpus/queries. Gates: R@5 ≥ 0.2310 (non-inferiority); identifier-heavy R@10 ≥ 0.2583; tokens ≤ 1.15 × baseline; query p95 ≤ 2,850 ms. Continuity monitored, not gated (n=20) |
| 26       | [Query-instruction ablation](./26-query-instruction-ablation-2026-09-08/)                          | 2026-09-08 | PLANNED (gates frozen)  | `improve-rag-input-quality-5` task 5.3. Raw vs instructed queries on the frozen exp 22 index (instruction excluded from index identity, task 4.8). Gates: paired R@5 lift ≥ +0.0300; identifier-heavy R@10 ≥ 0.2583; query p95 ≤ 2,850 ms with interleaved arms |
