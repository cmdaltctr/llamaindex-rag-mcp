...
def summarise_cell(cell: dict) -> dict:
    ...
    return {
        ...
        "sparse_only": {
            ...
            "cold_first_query_s": round(cold_t[0], 4) if cold_t else None,
        },
        "hybrid": {
        ...
        "latency": {
            "warm_p50_s": round(statistics.median(warm_t), 4) if warm_t else None,
            "warm_p95_s": round(_pctl(warm_t, 0.95), 4),
...
def main() -> None:
    ...
    lines += [
        ...
        "| Phase | BM25 | Native |",
        "| --- | --- | --- |",
        f"| Cold first query | {m['sparse_only']['cold_first_query_s']} | {n['sparse_only']['cold_first_query_s']} |",
        f"| Warm p50 | {m['latency']['warm_p50_s']} | {n['latency']['warm_p50_s']} |",
        f"| Warm p95 | {m['latency']['warm_p95_s']} | {n['latency']['warm_p95_s']} |",
        "",
