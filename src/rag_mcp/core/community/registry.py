...
register("louvain", "rag_mcp.core.community.louvain:partition")
...
register(
    "leiden",
    "rag_mcp.core.community.leiden:partition",
    availability_path="rag_mcp.integrations.leidenalg:require_leiden_installed",
)
