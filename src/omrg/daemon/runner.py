...
def watch_directory(
    ...
    # omrg.daemon.watcher, so scoping to __name__ would silence exactly
    ...
    if verbose:
        ...
        # pre-configured omrg.daemon.watcher silent.
        logging.getLogger("omrg.daemon").setLevel(logging.DEBUG)
        logging.getLogger("omrg.daemon.watcher").setLevel(logging.DEBUG)
