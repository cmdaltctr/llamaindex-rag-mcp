...
_NAMES: dict[str, str] = {
    ...
    "extract_metadata_with_status_async": ".extractor",
    ...
    "_get_classify_max_attempts": "._common",
    "_resolve_classify_timeout": "._common",
    "_resolve_pipeline_timeout": "._common",
    "_signal_degraded": "._common",
    "_retry_sleep": "._common",
