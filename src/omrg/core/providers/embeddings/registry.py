...
register("ollama", "omrg.core.providers.embeddings.ollama:build")
register("llamacpp", "omrg.core.providers.embeddings.llamacpp:build")
register("openrouter", "omrg.core.providers.embeddings.openrouter:build")
