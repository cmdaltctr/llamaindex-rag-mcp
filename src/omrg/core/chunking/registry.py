...
register("sentence", "omrg.core.chunking.sentence:chunk_sentence_file_async")
register("code", "omrg.core.chunking.code:chunk_code_file_async")
register("config", "omrg.core.chunking.config_file:chunk_config_file")
