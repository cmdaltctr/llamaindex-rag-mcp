...
_BASE_EXECUTED = 1798  # Includes document-backend registry + orchestrator pins,
...
# embedding-write-contract validator suite plus the Experiment 14
# harness regressions (validate-embedding-write-contract, ebc934b); and
# the stable source/chunk lineage suites (add-stable-source-chunk-lineage).
