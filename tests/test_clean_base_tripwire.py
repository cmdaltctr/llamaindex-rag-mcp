...
_BASE_EXECUTED = 1656  # Includes Exp14, PDF-reader default, registry drift, review-fix pins,
# the login-watcher installer suite (53 tests) with security-audit and
# contention-warning/summary-decline pins.
