...
_BASE_EXECUTED = 1829  # Includes document-backend registry + orchestrator pins,
...
# the CLI invalid-path regression (fix/cli-delete-invalid-path); and the
# embedding norm-guard suite (guard-embedding-normalisation).
